...
public class TrelloAnswer {
    ...
    public String toString() {
        ...
        sb.append(TrelloAnswer.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
